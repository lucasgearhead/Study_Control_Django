...
class Subject(models.Model):
    # Definindo um campo de caractere para o nome da disciplina com no máximo 100 caracteres
    name = models.CharField(max_length=100)
    
    # Definindo um campo de caractere para a descrição da disciplina com no máximo 255 caracteres
