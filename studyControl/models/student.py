...
class Student(models.Model):
    # Definindo um campo de caractere para o nome do estudante com no máximo 100 caracteres
    name = models.CharField(max_length=100)
    
    # Definindo um campo de email para o email do estudante com no máximo 100 caracteres
